  ...
  return (
    <form onSubmit={handleAddTodo} className="flex gap-2 w-full mb-4">
      ...
      <input
        ...
        className="px-3 py-2 rounded-xl border border-slate-200 text-slate-700 text-sm font-medium bg-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100 outline-none cursor-pointer hover:border-slate-300 transition-colors"
      />
      <Button
        type="submit"
